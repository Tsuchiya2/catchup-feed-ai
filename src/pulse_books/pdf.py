...
pages cleanly. PyMuPDF is dual-licensed (GNU AGPL v3.0, or a commercial
license from Artifex); this project takes the AGPL option and is therefore
itself AGPL-3.0-or-later (see LICENSE / NOTICE).
