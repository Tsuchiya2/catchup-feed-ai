...
### Docker Execution
Commands are executed via: `docker compose exec catchup-ai`
...
### Architecture
- Pure AI service (embedding generation, RAG)
- gRPC server (port 50051)
- Backend connection via gRPC (catchup-feed-backend, port 50052)
